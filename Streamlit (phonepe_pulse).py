...
st.write(" Karnataka. Sameer Nigam, Rahul Chari, and Burzin Engineer started PhonePe")
st.write("in December 2015. In August 2016, the PhonePe app, which is based on the")
st.write(" Unified Payments Interface (UPI), went live. Flipkart, a Walmart affiliate")
st.write(" owns it. PhonePe is available in 11 different Indian languages")   
st.write(" PhonePe allows users to transfer and receive money")
